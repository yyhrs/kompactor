...
public:
	...
	Kompactor(const QFileInfo &input, const QFileInfo &output, int vertexPrecision, int normalPrecision);
	~Kompactor() = default;
...
private:
	...
	void writeShadow(QFile &fileIn, QFile &fileOut, Alamo::Model &model, const Alamo::Model::ShadowEntryPoint &entryPoint, Buffer<Alamo::MASTER_VERTEX> &vertices, Buffer<uint16_t> &indices);
